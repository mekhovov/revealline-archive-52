...
COMMIT = 'b17e61d58f23c758802f54cb929ce47c25dd5416'
TREE = 'a0d27835d736f6a5058f372f5c17e76cc8bdcc5b'
SOURCE = '1107f570508e0d107440236b6aeedbce8506cd7d'
SOURCE_TREE = '793ee7e682e206e0914754cf60fd93af0792c463'
INVENTORY_SHA = 'ed1220b2b1d3d5665391988797af44db869a0a16c302fddc2c8ab59e3ffc5aa5'
EXPECTED_FILES = 3859
EXPECTED_BYTES = 614523893
...
def validate_execution_binding():
    ...
    require(request['runId'] == 35783546172 and set(request['pins']) == ROLES, 'Wrong production run or incomplete authority')
    ...
    with zipfile.ZipFile(io.BytesIO(zip_raw)) as archive:
        ...
        require(receipt['format'] == 'revealline-metadata-pages-artifact.v1' and receipt['controllerCommit'] == COMMIT and receipt['controllerTree'] == TREE and receipt['currentVersion'] == 'v0.84.0' and receipt['gameSourceRevision'] == SOURCE and receipt['qualifiedSourceTree'] == SOURCE_TREE, 'Wrong frozen receipt source/controller')
        require(receipt['publishable'] is True and receipt['browserAdmissionsRequired'] is True and receipt['admittedArchives'] == 52, 'Receipt is not actual production eligible')
        ...
        require(extraction['version'] == 'v0.84.0' and extraction['gameSourceRevision'] == SOURCE and extraction['distributionSha256'] == '923d5588b2ab6d3223546ab73fc6247b32fb0152153a13f6d1e6e7341062725f' and extraction['manifestSha256'] == 'ffca25551a2b479575648603d6eacd32b2515abeabf5494562402a90ae7d6ca5' and extraction['crcAndHashesVerified'] is True, 'Frozen ZIP source/hash identity mismatch')
